...
export default function EventCard({ event, onAdd, autoCheckout = false }) {
  ...
  return (
    <article
      ref={ref}
      className="bg-gradient-to-br from-[#0b0210] to-[#120018] rounded-2xl border-2 border-gold/80 
                shadow-xl overflow-hidden transform transition-transform 
                hover:scale-[1.02] hover:shadow-2xl"
      style={{ borderColor: 'rgba(212,175,55,0.95)' }}
    >
      ...
      <div className="p-6">
        ...
        <div className="flex items-center gap-4 text-sm text-white/80 mb-3">
          <div className="flex items-center gap-2">
            <svg className="w-5 h-5 text-gold" viewBox="0 0 24 24" fill="none" stroke="currentColor">
              <path d="M8 7V3M16 7V3M3 11h18" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          ...
          <div className="flex items-center gap-2">
            <svg className="w-5 h-5 text-gold" viewBox="0 0 24 24" fill="none" stroke="currentColor">
              <path d="M21 10c0 6-9 11-9 11S3 16 3 10a9 9 0 0118 0z" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
        ...
        <div className="grid grid-cols-2 gap-3 text-white/80 mb-4">
          ...
          <div className="text-sm">
            Coordinator: <strong className="text-white">{event.coordinator}</strong>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between relative z-40 pointer-events-auto">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 
                       ...
                       text-black rounded-full shadow-md hover:shadow-lg 
